...
import { x as slebEncode, y as safeReadUint8, z as iexp2, A as writeIntLE, B as readIntLE, C as writeUIntLE, D as readUIntLE, E as safeRead, F as uint8ToDataView, G as lebEncode, H as concat, I as lebDecode, J as slebDecode, P as PipeArrayBuffer, K as Principal$1, L as InputError, M as CborEncodeErrorCode, O as CborDecodeErrorCode, Q as ExpiryJsonDeserializeErrorCode, T as utf8ToBytes, _ as _validateObject, U as isHash, V as abytes, W as mod, X as concatBytes, Y as bytesToNumberBE, Z as isBytes, $ as FpInvertBatch, a0 as Field, a1 as _createCurveFields, a2 as wNAF, a3 as ensureBytes, a4 as _abool2, a5 as _abytes2, a6 as normalizeZ, a7 as mulEndoUnsafe, a8 as bytesToHex, a9 as pippenger, aa as inRange, ab as memoized, ac as negateCt, ad as bitMask, ae as bitLen, af as validateField, ag as getMinHashLength, ah as mapHashToField, ai as randomBytes, aj as FpPow, ak as FpLegendre, al as notImplemented, am as bitGet, an as sha256, ao as numberToBytesBE, ap as UNREACHABLE_ERROR, aq as UnknownError, ar as HashTreeDecodeErrorCode, as as uint8Equals, at as ProtocolError, au as CertificateVerificationErrorCode, av as TrustError, aw as CertificateTimeErrorCode, ax as UnexpectedErrorCode, ay as CertificateHasTooManyDelegationsErrorCode, az as CertificateNotAuthorizedErrorCode, aA as MissingLookupValueErrorCode, aB as DerKeyLengthMismatchErrorCode, aC as DerPrefixMismatchErrorCode, aD as LookupErrorCode, aE as MalformedLookupFoundValueErrorCode, aF as hexToBytes, aG as ExternalError, aH as MissingRootKeyErrorCode, aI as AgentError, aJ as wrapDER, aK as unwrapDER, aL as DerDecodeErrorCode, aM as ED25519_OID, aN as hashOfMap, aO as MalformedPublicKeyErrorCode, aP as ed25519, aQ as QuerySignatureVerificationFailedErrorCode, aR as AnonymousIdentity, aS as IngressExpiryInvalidErrorCode, aT as CreateHttpAgentErrorCode, aU as IdentityInvalidErrorCode, aV as requestIdOf, aW as HttpV3ApiNotSupportedErrorCode, aX as TimeoutWaitingForResponseErrorCode, aY as uint8FromBufLike, aZ as HttpErrorCode, a_ as TransportError, a$ as HttpFetchErrorCode, b0 as MalformedSignatureErrorCode, b1 as CertificateOutdatedErrorCode, b2 as MissingSignatureErrorCode, b3 as IC_RESPONSE_DOMAIN_SEPARATOR, b4 as HttpDefaultFetchErrorCode, b5 as RequestStatusDoneNoReplyErrorCode, b6 as RejectError, b7 as CertifiedRejectErrorCode, b8 as InvalidReadStateRequestErrorCode, b9 as MissingCanisterIdErrorCode, ba as UncertifiedRejectErrorCode, bb as UncertifiedRejectUpdateErrorCode, bc as useInternetIdentity, r as reactExports } from "./index-C68clJlo.js";
...
function from_candid_BusinessType_n20(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n8(_uploadFile, _downloadFile, value);
}
function from_candid_CaseStatus_n24(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n25(_uploadFile, _downloadFile, value);
}
function from_candid_Case_n22(_uploadFile, _downloadFile, value) {
...
function from_candid_SupplyRequestStatus_n33(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n34(_uploadFile, _downloadFile, value);
}
function from_candid_SupplyRequest_n31(_uploadFile, _downloadFile, value) {
  return from_candid_record_n32(_uploadFile, _downloadFile, value);
}
function from_candid_UserProfile_n18(_uploadFile, _downloadFile, value) {
...
function from_candid_vec_n29(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_Case_n22(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n30(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_SupplyRequest_n31(_uploadFile, _downloadFile, x2));
}
...
function from_candid_vec_n39(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_UserProfile_n18(_uploadFile, _downloadFile, x2));
}
function to_candid_BusinessType_n42(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n4(_uploadFile, _downloadFile, value);
}
function to_candid_CaseStatus_n47(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n48(_uploadFile, _downloadFile, value);
}
function to_candid_CreateCaseInput_n43(_uploadFile, _downloadFile, value) {
...
function to_candid_SaveProfileInput_n40(_uploadFile, _downloadFile, value) {
...
function to_candid_SupplyRequestStatus_n49(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n50(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateCaseInput_n45(_uploadFile, _downloadFile, value) {
