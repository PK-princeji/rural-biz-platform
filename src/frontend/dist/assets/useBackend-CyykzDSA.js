...
const CANISTER_ID = _env.CANISTER_ID_BACKEND || _env.VITE_CANISTER_ID_BACKEND || "";
if (!CANISTER_ID && !USE_MOCK) {
  console.warn(
    "[useBackend] Canister ID is not set. Ensure CANISTER_ID_BACKEND is available in the build environment. Backend calls will fail until a valid canister ID is provided."
  );
}
