...
import { S as Subscribable, p as pendingThenable, b as resolveEnabled, s as shallowEqualObjects, c as resolveStaleTime, n as noop, e as environmentManager, i as isValidTimeout, t as timeUntilStale, d as timeoutManager, f as focusManager, g as fetchState, h as replaceData, k as notifyManager, l as hashKey, m as getDefaultState, r as reactExports, o as shouldThrowError, q as useQueryClient, a as useLanguage, j as jsxRuntimeExports, u as useNavigate, v as Skeleton } from "./index-Cqgdtvq_.js";
import { B as Badge } from "./badge-BFqi5fWj.js";
import { c as createLucideIcon, B as Button, L as Layout } from "./Layout-CMm-fnAt.js";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "./card-CZVE8uIW.js";
import { C as CaseStatus, S as Specialization, a as SupplyRequestStatus, E as EnrollmentStatus } from "./backend.d-Gv2yjQfN.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle } from "./dialog-W1NwGxNk.js";
import { I as Input } from "./input-DdImJ8cC.js";
import { L as Label } from "./label-DRVaTPOP.js";
import { T as Textarea } from "./textarea-BuhiBtTy.js";
import { u as useBackend } from "./useBackend-ZkNMQPF_.js";
import { C as CircleCheck } from "./circle-check-DHvOnxeR.js";
import { S as Shield } from "./shield-mAz7-JGn.js";
import { H as Headphones, U as UserCheck, A as ArrowRight, B as Bot, G as GraduationCap } from "./user-check-LfIcZUQE.js";
import { Z as Zap } from "./zap-Do5gcKzr.js";
import { P as ProtectedRoute } from "./ProtectedRoute-CKjnu-Uv.js";
import { M as MapPin, P as Phone } from "./phone-BULS4TG5.js";
import { C as CirclePlus, F as FileText } from "./file-text-DHpkVtE6.js";
import { C as Clock } from "./clock-CsXXIi0t.js";
import { B as Briefcase, U as User } from "./user-Dbz1FURc.js";
import { C as ChevronRight } from "./chevron-right-DZGwTLEl.js";
import { B as BookOpen } from "./book-open-5RlqGUNv.js";
import { T as TrendingUp, L as Lightbulb } from "./trending-up-Be3dXZKa.js";
import { M as MessageCircle } from "./message-circle-C5u5-kXH.js";
import { C as ChevronUp } from "./chevron-up-DLBYlfmV.js";
import { C as ChevronDown } from "./chevron-down-hBPjUnjf.js";
import "./index-CFRWVR9Q.js";
...
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border shadow-subtle", "data-ocid": ocid, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 flex items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
...
function ProgressTracker({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Card,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-3 pt-4 px-4 sm:px-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base font-display font-bold text-foreground flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "px-4 sm:px-5 pb-4", children: [
          loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: [0, 1, 2, 3, 4, 5].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "flex-1 h-14 rounded-xl" }, i)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-stretch gap-1 sm:gap-2 overflow-x-auto pb-1", children: JOURNEY_STEPS.map((step, idx) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `flex-1 min-w-[52px] flex flex-col items-center gap-1.5 p-2 rounded-xl border transition-smooth ${isActive ? "border-accent bg-accent/10 shadow-subtle" : isDone ? "border-accent/30 bg-accent/5" : "border-border/50 bg-muted/20 opacity-50"}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: `w-7 h-7 rounded-full flex items-center justify-center shrink-0 ${isActive ? "bg-accent text-white" : isDone ? "bg-accent/20 text-accent" : "bg-muted text-muted-foreground"}`,
                        children: isDone ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4" }) : step.icon
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: `text-[10px] font-body font-medium text-center leading-tight ${isActive ? "text-accent" : isDone ? "text-accent/80" : "text-muted-foreground"}`,
                        children: lang === "hi" ? step.labelHi : step.label
                      }
                    ),
                    isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-1 rounded-full bg-accent animate-pulse" })
                  ]
                }
              ),
              idx < JOURNEY_STEPS.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-3 h-3 text-border mx-0.5 shrink-0 hidden sm:block" })
            ] }, step.id);
          }) }),
          !loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground font-body mt-3 text-center", children: [
            t(`Step ${currentStep} of 6`, `चरण ${currentStep} / 6`),
            currentStep < 6 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 text-accent font-medium", children: t("— Keep going!", "— आगे बढ़ते रहें!") })
          ] })
        ] })
      ]
    }
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl bg-accent/10 flex items-center justify-center shrink-0 mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 text-accent" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body font-semibold text-foreground", children: t("Talk to Our Expert Team", "हमारे विशेषज्ञ से बात करें") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: t(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: WHATSAPP_LINK, target: "_blank", rel: "noopener noreferrer", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: PHONE_LINK, children: [
...
function AIResultsSection({
  ...
  const { t } = useLanguage();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "dashboard.ai_results_section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-lg font-display font-bold text-foreground flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "w-5 h-5 text-primary" }),
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-36 rounded-xl" }) : result ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        className: "border-primary/20 bg-gradient-to-br from-primary/5 to-card shadow-subtle",
        "data-ocid": "dashboard.ai_result_card",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 sm:p-5 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body text-muted-foreground uppercase tracking-wide mb-1", children: t("Recommended Business", "अनुशंसित व्यवसाय") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-display font-bold text-foreground", children: BUSINESS_LABEL[result.businessType] ?? String(result.businessType) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-accent/10 text-accent border-accent/30 font-body text-xs px-2 py-0.5", children: [
          ...
          result.reasons.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body font-semibold text-muted-foreground uppercase tracking-wide mb-2", children: t("Why this is right for you", "यह आपके लिए क्यों सही है") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1.5", children: result.reasons.map((reason) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 pt-1 border-t border-border/50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                size: "sm",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlus, { className: "w-3.5 h-3.5 mr-1.5" }),
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { className: "w-7 h-7 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-display font-semibold text-foreground mb-1", children: t("Discover Your Best Business", "अपना बेस्ट व्यवसाय खोजें") }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Badge,
                    {
                      ...
                      children: BUSINESS_LABEL[c.businessType] ?? String(c.businessType)
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Badge,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 text-xs text-muted-foreground font-body", children: [
            (program == null ? void 0 : program.sector) && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                ...
                children: BUSINESS_LABEL[program.sector] ?? String(program.sector)
              }
            ),
...
function StatsSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3", children: [0, 1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border shadow-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 flex items-center gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-8 rounded" }),
...
function DashboardContent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressTracker, { currentStep, loading: casesLoading }),
    casesLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(StatsSkeleton, {}) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCard,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCard,
        {
          ...
          value: pending,
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-4 h-4 text-yellow-700" }),
          bg: "bg-yellow-500/10",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCard,
        {
          ...
          value: inProgress,
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "w-4 h-4 text-primary" }),
          bg: "bg-primary/10",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCard,
        {
          ...
          value: completed,
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-accent" }),
          bg: "bg-accent/10",
          ocid: "dashboard.stat_completed_card"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(RequestCallBanner, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AIResultsSection,
      {
        result: aiResult,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "dashboard.cases_section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-display font-bold text-foreground", children: t("My Requests", "मेरे अनुरोध") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
      ...
      casesError ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-display font-semibold text-foreground mb-1", children: activeFilter === "All" ? t("No requests yet", "अभी कोई अनुरोध नहीं") : t("No requests in this filter", "इस फ़िल्टर में कोई अनुरोध नहीं") }),
    ...
    (supplyLoading || supplyRequests.length > 0 || supplyError) && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "dashboard.supply_section", children: [
      ...
      ) : supplyLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: [0, 1].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-16 rounded-xl" }, i)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
    ...
    (enrollmentsLoading || enrollments.length > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "dashboard.trainings_section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      enrollmentsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: [0, 1].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-16 rounded-xl" }, i)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          className: "border-border shadow-subtle",
    ...
    !enrollmentsLoading && enrollments.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-5 h-5 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body font-semibold text-foreground", children: t("Explore Training Programs", "प्रशिक्षण कार्यक्रम देखें") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: t(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: t("Browse Programs", "कार्यक्रम देखें")
            }
          )
        ]
      }
