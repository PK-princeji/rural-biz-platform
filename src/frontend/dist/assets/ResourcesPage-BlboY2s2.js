import { r as reactExports, j as jsxRuntimeExports, v as Skeleton } from "./index-Bv79MXo9.js";
import { B as Badge } from "./badge-CB92I89i.js";
import { u as useAuth, L as Layout, B as Button } from "./Layout-CN7ytZ9a.js";
import { C as Card, a as CardContent } from "./card-CuINqNct.js";
...
const STATUS_COLOR = {
  ...
  processing: "bg-blue-100/80 text-blue-800 border-blue-300 dark:bg-blue-900/30 dark:text-blue-300 dark:border-blue-700",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shrink-0 flex flex-col items-end gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `text-xs font-body font-medium px-2 py-0.5 rounded-full border ${STATUS_COLOR[statusStr] ?? "bg-muted text-muted-foreground border-border"}`,
