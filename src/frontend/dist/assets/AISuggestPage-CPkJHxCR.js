import { j as jsxRuntimeExports, r as reactExports, v as Skeleton, L as Link } from "./index-Cqgdtvq_.js";
import { B as Badge } from "./badge-BFqi5fWj.js";
import { L as Layout, B as Button } from "./Layout-CMm-fnAt.js";
import { P as ProtectedRoute } from "./ProtectedRoute-CKjnu-Uv.js";
import { u as useBackend } from "./useBackend-ZkNMQPF_.js";
import { m as motion, A as AnimatePresence } from "./proxy-wRBxfUha.js";
...
function buildWhatsAppUrl(businessType) {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Get Expert Call / विशेषज्ञ से बात करें" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg flex-shrink-0", children: "📞" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-center text-muted-foreground mt-2 font-body", children: "WhatsApp पर तुरंत संपर्क करें · Contact us on WhatsApp" })
            ]
          }
        ),
