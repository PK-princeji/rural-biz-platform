...
import { A as slebEncode, B as safeReadUint8, C as iexp2, D as writeIntLE, E as readIntLE, F as writeUIntLE, G as readUIntLE, H as safeRead, I as uint8ToDataView, J as lebEncode, K as concat, M as lebDecode, O as slebDecode, P as PipeArrayBuffer, Q as Principal$1, T as InputError, U as CborEncodeErrorCode, V as CborDecodeErrorCode, W as ExpiryJsonDeserializeErrorCode, X as utf8ToBytes, _ as _validateObject, Y as isHash, Z as abytes, $ as mod, a0 as concatBytes, a1 as bytesToNumberBE, a2 as isBytes, a3 as FpInvertBatch, a4 as Field, a5 as _createCurveFields, a6 as wNAF, a7 as ensureBytes, a8 as _abool2, a9 as _abytes2, aa as normalizeZ, ab as mulEndoUnsafe, ac as bytesToHex, ad as pippenger, ae as inRange, af as memoized, ag as negateCt, ah as bitMask, ai as bitLen, aj as validateField, ak as getMinHashLength, al as mapHashToField, am as randomBytes, an as FpPow, ao as FpLegendre, ap as notImplemented, aq as bitGet, ar as sha256, as as numberToBytesBE, at as UNREACHABLE_ERROR, au as UnknownError, av as HashTreeDecodeErrorCode, aw as uint8Equals, ax as ProtocolError, ay as CertificateVerificationErrorCode, az as TrustError, aA as CertificateTimeErrorCode, aB as UnexpectedErrorCode, aC as CertificateHasTooManyDelegationsErrorCode, aD as CertificateNotAuthorizedErrorCode, aE as MissingLookupValueErrorCode, aF as DerKeyLengthMismatchErrorCode, aG as DerPrefixMismatchErrorCode, aH as LookupErrorCode, aI as MalformedLookupFoundValueErrorCode, aJ as hexToBytes, aK as ExternalError, aL as MissingRootKeyErrorCode, aM as AgentError, aN as wrapDER, aO as unwrapDER, aP as DerDecodeErrorCode, aQ as ED25519_OID, aR as hashOfMap, aS as MalformedPublicKeyErrorCode, aT as ed25519, aU as QuerySignatureVerificationFailedErrorCode, aV as AnonymousIdentity, aW as IngressExpiryInvalidErrorCode, aX as CreateHttpAgentErrorCode, aY as IdentityInvalidErrorCode, aZ as requestIdOf, a_ as HttpV3ApiNotSupportedErrorCode, a$ as TimeoutWaitingForResponseErrorCode, b0 as uint8FromBufLike, b1 as HttpErrorCode, b2 as TransportError, b3 as HttpFetchErrorCode, b4 as MalformedSignatureErrorCode, b5 as CertificateOutdatedErrorCode, b6 as MissingSignatureErrorCode, b7 as IC_RESPONSE_DOMAIN_SEPARATOR, b8 as HttpDefaultFetchErrorCode, b9 as RequestStatusDoneNoReplyErrorCode, ba as RejectError, bb as CertifiedRejectErrorCode, bc as InvalidReadStateRequestErrorCode, bd as MissingCanisterIdErrorCode, be as UncertifiedRejectErrorCode, bf as UncertifiedRejectUpdateErrorCode, bg as useInternetIdentity, r as reactExports } from "./index-Bv79MXo9.js";
...
const Specialization$1 = Variant({
  "fishery": Null,
  "goatFarming": Null,
  "poultry": Null,
  "agriculture": Null
});
const CreateExpertInput = Record({
  "contactInfo": Text,
  "name": Text,
...
const ResourceCategory = Variant({
  "poultry": Null,
  "fish": Null,
  "goat": Null,
  "seeds": Null
});
const CreateResourceInput = Record({
  "name": Text,
  "isAvailable": Bool,
  "description": Text,
  "category": ResourceCategory
});
const ResourceId = Nat;
...
const CreateTrainingInput = Record({
  "title": Text,
  "duration": Text,
  "description": Text,
  "sector": BusinessType
});
const TrainingId = Nat;
const TrainingProgram = Record({
  "id": TrainingId,
  "title": Text,
  "duration": Text,
  "createdAt": Timestamp,
...
const EnrollTrainingInput = Record({ "programId": TrainingId });
const EnrollmentId = Nat;
...
const AIQuizResult = Record({
  "reasons": Vec(Text),
  "createdAt": Timestamp,
  "businessType": BusinessType,
  "confidence": Text
});
const ContactLeadId = Nat;
const ContactLead = Record({
  "id": ContactLeadId,
  "status": Text,
  "userId": Opt(UserId),
  "name": Text,
...
const PremiumRequestId = Nat;
const PremiumRequest = Record({
  "id": PremiumRequestId,
  "userId": UserId,
  "name": Text,
  "createdAt": Timestamp,
...
const SupplyRequestId = Nat;
const SupplyRequestStatus = Variant({
  "cancelled": Null,
  "pending": Null,
  "delivered": Null,
  "processing": Null
});
const SupplyRequest = Record({
  "id": SupplyRequestId,
...
const CreateCaseInput = Record({
  "businessType": BusinessType,
  "description": Text,
  "photoUrl": Opt(Text)
});
const CreateContactLeadInput = Record({
  "name": Text,
  "whatsapp": Text,
  "email": Text,
  "phone": Text,
...
const CreatePremiumRequestInput = Record({
  "name": Text,
  "email": Text,
  "mobile": Text,
  "reason": Text
});
const CreateSupplyRequestInput = Record({
  "resourceId": ResourceId,
  "deliveryLocation": Text,
  "quantity": Nat
});
const UpdateCaseInput = Record({
  "status": Opt(CaseStatus),
  "assignedExpertId": Opt(ExpertId),
  "adminNotes": Opt(Text)
});
Service({
  "addExpert": Func([CreateExpertInput], [Expert], []),
  "addResource": Func([CreateResourceInput], [Resource], []),
  "checkIsAdmin": Func([], [Bool], ["query"]),
  "createTrainingProgram": Func(
    [CreateTrainingInput],
    [TrainingProgram],
    []
  ),
  "enrollInTraining": Func(
    [EnrollTrainingInput],
    [TrainingEnrollment],
    []
  ),
  ...
  "getExpert": Func([ExpertId], [Opt(Expert)], ["query"]),
  "getMyAIQuizResult": Func([], [Opt(AIQuizResult)], ["query"]),
  "getMyCases": Func([], [Vec(Case)], ["query"]),
  "getMyContactLeads": Func([], [Vec(ContactLead)], ["query"]),
  "getMyPremiumRequest": Func([], [Opt(PremiumRequest)], ["query"]),
  "getMySupplyRequests": Func([], [Vec(SupplyRequest)], ["query"]),
  "getMyTrainingEnrollments": Func(
    [],
    [Vec(TrainingEnrollment)],
    ["query"]
  ),
  "getProgramEnrollments": Func(
    [TrainingId],
    [Vec(TrainingEnrollment)],
    ["query"]
  ),
  "getResource": Func([ResourceId], [Opt(Resource)], ["query"]),
  "getSupplyRequest": Func(
    [SupplyRequestId],
    [Opt(SupplyRequest)],
    ["query"]
  ),
  "getTrainingProgram": Func(
    [TrainingId],
    [Opt(TrainingProgram)],
    ["query"]
  ),
  ...
  "listAllCases": Func([], [Vec(Case)], ["query"]),
  "listAllContactLeads": Func([], [Vec(ContactLead)], ["query"]),
  "listAllSupplyRequests": Func([], [Vec(SupplyRequest)], ["query"]),
  "listExperts": Func([], [Vec(Expert)], ["query"]),
  "listPremiumRequests": Func([], [Vec(PremiumRequest)], ["query"]),
  "listResources": Func([], [Vec(Resource)], ["query"]),
  "listTrainingPrograms": Func([], [Vec(TrainingProgram)], ["query"]),
  "listUserProfiles": Func([], [Vec(UserProfile)], ["query"]),
  "markPremiumRequestContacted": Func([PremiumRequestId], [], []),
  "saveCallerUserProfile": Func([SaveProfileInput], [], []),
  "setExpertActive": Func([ExpertId, Bool], [Opt(Expert)], []),
  "submitAIQuiz": Func([QuizAnswers], [AIQuizResult], []),
  "submitCase": Func([CreateCaseInput], [Case], []),
  "submitContactLead": Func([CreateContactLeadInput], [Nat], []),
  "submitPremiumRequest": Func(
    [CreatePremiumRequestInput],
    [PremiumRequest],
    []
  ),
  "submitSupplyRequest": Func(
    [CreateSupplyRequestInput],
    [SupplyRequest],
    []
  ),
  "toggleTrainingProgramActive": Func([TrainingId], [], []),
  "updateCase": Func([CaseId, UpdateCaseInput], [Opt(Case)], []),
  "updateSupplyRequestStatus": Func(
    [SupplyRequestId, SupplyRequestStatus],
    [Opt(SupplyRequest)],
    []
  ),
  "updateTrainingEnrollmentStatus": Func(
...
const idlFactory = ({ IDL: IDL2 }) => {
  const Specialization2 = IDL2.Variant({
    "fishery": IDL2.Null,
    "goatFarming": IDL2.Null,
    "poultry": IDL2.Null,
    "agriculture": IDL2.Null
  });
  const CreateExpertInput2 = IDL2.Record({
    "contactInfo": IDL2.Text,
    "name": IDL2.Text,
    "specialization": Specialization2
  });
  const ExpertId2 = IDL2.Nat;
  const Timestamp2 = IDL2.Int;
  const Expert2 = IDL2.Record({
    "id": ExpertId2,
    "contactInfo": IDL2.Text,
    "assignedCasesCount": IDL2.Nat,
    "name": IDL2.Text,
    "createdAt": Timestamp2,
    "isActive": IDL2.Bool,
    "specialization": Specialization2
  });
  const ResourceCategory2 = IDL2.Variant({
    "poultry": IDL2.Null,
    "fish": IDL2.Null,
    "goat": IDL2.Null,
    "seeds": IDL2.Null
  });
  const CreateResourceInput2 = IDL2.Record({
    "name": IDL2.Text,
    "isAvailable": IDL2.Bool,
    "description": IDL2.Text,
    "category": ResourceCategory2
  });
  const ResourceId2 = IDL2.Nat;
  const Resource2 = IDL2.Record({
    "id": ResourceId2,
    "name": IDL2.Text,
    "isAvailable": IDL2.Bool,
    "description": IDL2.Text,
  ...
  const BusinessType2 = IDL2.Variant({
    "fishery": IDL2.Null,
    "goatFarming": IDL2.Null,
    "poultry": IDL2.Null,
    "agriculture": IDL2.Null
  });
  const CreateTrainingInput2 = IDL2.Record({
    "title": IDL2.Text,
    "duration": IDL2.Text,
    "description": IDL2.Text,
    "sector": BusinessType2
  });
  const TrainingId2 = IDL2.Nat;
  const TrainingProgram2 = IDL2.Record({
    "id": TrainingId2,
    "title": IDL2.Text,
    "duration": IDL2.Text,
    "createdAt": Timestamp2,
  ...
  const EnrollTrainingInput2 = IDL2.Record({ "programId": TrainingId2 });
  const EnrollmentId2 = IDL2.Nat;
  const EnrollmentStatus2 = IDL2.Variant({
    "enrolled": IDL2.Null,
    "completed": IDL2.Null,
    "ongoing": IDL2.Null
  });
  ...
  const TrainingEnrollment2 = IDL2.Record({
    "id": EnrollmentId2,
    "status": EnrollmentStatus2,
    "userId": UserId2,
    "updatedAt": Timestamp2,
    "enrolledAt": Timestamp2,
    "programId": TrainingId2
  });
  const UserProfile2 = IDL2.Record({
    "id": UserId2,
    "aiRecommendation": IDL2.Opt(IDL2.Text),
    "name": IDL2.Text,
    "createdAt": Timestamp2,
    "whatsapp": IDL2.Text,
  ...
  const CaseStatus2 = IDL2.Variant({
    "pending": IDL2.Null,
    "completed": IDL2.Null,
  ...
  const Case2 = IDL2.Record({
    ...
    "updatedAt": Timestamp2,
    "assignedExpertId": IDL2.Opt(ExpertId2),
    "adminNotes": IDL2.Opt(IDL2.Text)
  });
  const AIQuizResult2 = IDL2.Record({
    "reasons": IDL2.Vec(IDL2.Text),
    "createdAt": Timestamp2,
    "businessType": BusinessType2,
    "confidence": IDL2.Text
  });
  const ContactLeadId2 = IDL2.Nat;
  const ContactLead2 = IDL2.Record({
    "id": ContactLeadId2,
    "status": IDL2.Text,
    "userId": IDL2.Opt(UserId2),
    "name": IDL2.Text,
    "whatsapp": IDL2.Text,
  ...
  const PremiumRequestId2 = IDL2.Nat;
  const PremiumRequest2 = IDL2.Record({
    "id": PremiumRequestId2,
    "userId": UserId2,
    "name": IDL2.Text,
    "createdAt": Timestamp2,
    "email": IDL2.Text,
    "isContacted": IDL2.Bool,
    "mobile": IDL2.Text,
    "reason": IDL2.Text
  });
  const SupplyRequestId2 = IDL2.Nat;
  const SupplyRequestStatus2 = IDL2.Variant({
    "cancelled": IDL2.Null,
    "pending": IDL2.Null,
    "delivered": IDL2.Null,
    "processing": IDL2.Null
  });
  const SupplyRequest2 = IDL2.Record({
    "id": SupplyRequestId2,
    "status": SupplyRequestStatus2,
  ...
  const QuizAnswers2 = IDL2.Record({
    "interest": IDL2.Text,
    "experience": IDL2.Text,
    "budget": IDL2.Text,
    "location": IDL2.Text,
    "landAvailable": IDL2.Text
  });
  const CreateCaseInput2 = IDL2.Record({
    "businessType": BusinessType2,
    "description": IDL2.Text,
    "photoUrl": IDL2.Opt(IDL2.Text)
  });
  const CreateContactLeadInput2 = IDL2.Record({
    "name": IDL2.Text,
    "whatsapp": IDL2.Text,
    "email": IDL2.Text,
    "phone": IDL2.Text,
  ...
  const CreatePremiumRequestInput2 = IDL2.Record({
    "name": IDL2.Text,
    "email": IDL2.Text,
    "mobile": IDL2.Text,
    "reason": IDL2.Text
  });
  const CreateSupplyRequestInput2 = IDL2.Record({
    "resourceId": ResourceId2,
    "deliveryLocation": IDL2.Text,
    "quantity": IDL2.Nat
  });
  const UpdateCaseInput2 = IDL2.Record({
    "status": IDL2.Opt(CaseStatus2),
    "assignedExpertId": IDL2.Opt(ExpertId2),
    "adminNotes": IDL2.Opt(IDL2.Text)
  });
  return IDL2.Service({
    "addExpert": IDL2.Func([CreateExpertInput2], [Expert2], []),
    "addResource": IDL2.Func([CreateResourceInput2], [Resource2], []),
    "checkIsAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "createTrainingProgram": IDL2.Func(
      [CreateTrainingInput2],
      [TrainingProgram2],
      []
    ),
    "enrollInTraining": IDL2.Func(
      [EnrollTrainingInput2],
      [TrainingEnrollment2],
      []
    ),
    "getCallerUserProfile": IDL2.Func([], [IDL2.Opt(UserProfile2)], ["query"]),
    "getCase": IDL2.Func([CaseId2], [IDL2.Opt(Case2)], ["query"]),
    "getExpert": IDL2.Func([ExpertId2], [IDL2.Opt(Expert2)], ["query"]),
    "getMyAIQuizResult": IDL2.Func([], [IDL2.Opt(AIQuizResult2)], ["query"]),
    "getMyCases": IDL2.Func([], [IDL2.Vec(Case2)], ["query"]),
    "getMyContactLeads": IDL2.Func([], [IDL2.Vec(ContactLead2)], ["query"]),
    "getMyPremiumRequest": IDL2.Func([], [IDL2.Opt(PremiumRequest2)], ["query"]),
    "getMySupplyRequests": IDL2.Func([], [IDL2.Vec(SupplyRequest2)], ["query"]),
    "getMyTrainingEnrollments": IDL2.Func(
      [],
      [IDL2.Vec(TrainingEnrollment2)],
      ["query"]
    ),
    "getProgramEnrollments": IDL2.Func(
      [TrainingId2],
      [IDL2.Vec(TrainingEnrollment2)],
      ["query"]
    ),
    "getResource": IDL2.Func([ResourceId2], [IDL2.Opt(Resource2)], ["query"]),
    "getSupplyRequest": IDL2.Func(
      [SupplyRequestId2],
      [IDL2.Opt(SupplyRequest2)],
      ["query"]
    ),
    "getTrainingProgram": IDL2.Func(
      [TrainingId2],
      [IDL2.Opt(TrainingProgram2)],
      ["query"]
    ),
    "getUserProfile": IDL2.Func([UserId2], [IDL2.Opt(UserProfile2)], ["query"]),
    "grantAdmin": IDL2.Func([IDL2.Principal], [], []),
    "listAllCases": IDL2.Func([], [IDL2.Vec(Case2)], ["query"]),
    "listAllContactLeads": IDL2.Func([], [IDL2.Vec(ContactLead2)], ["query"]),
    "listAllSupplyRequests": IDL2.Func([], [IDL2.Vec(SupplyRequest2)], ["query"]),
    "listExperts": IDL2.Func([], [IDL2.Vec(Expert2)], ["query"]),
    "listPremiumRequests": IDL2.Func([], [IDL2.Vec(PremiumRequest2)], ["query"]),
    "listResources": IDL2.Func([], [IDL2.Vec(Resource2)], ["query"]),
    "listTrainingPrograms": IDL2.Func(
      [],
      [IDL2.Vec(TrainingProgram2)],
      ["query"]
    ),
    "listUserProfiles": IDL2.Func([], [IDL2.Vec(UserProfile2)], ["query"]),
    "markPremiumRequestContacted": IDL2.Func([PremiumRequestId2], [], []),
    "saveCallerUserProfile": IDL2.Func([SaveProfileInput2], [], []),
    "setExpertActive": IDL2.Func([ExpertId2, IDL2.Bool], [IDL2.Opt(Expert2)], []),
    "submitAIQuiz": IDL2.Func([QuizAnswers2], [AIQuizResult2], []),
    "submitCase": IDL2.Func([CreateCaseInput2], [Case2], []),
    "submitContactLead": IDL2.Func([CreateContactLeadInput2], [IDL2.Nat], []),
    "submitPremiumRequest": IDL2.Func(
      [CreatePremiumRequestInput2],
      [PremiumRequest2],
      []
    ),
    "submitSupplyRequest": IDL2.Func(
      [CreateSupplyRequestInput2],
      [SupplyRequest2],
      []
    ),
    "toggleTrainingProgramActive": IDL2.Func([TrainingId2], [], []),
    "updateCase": IDL2.Func([CaseId2, UpdateCaseInput2], [IDL2.Opt(Case2)], []),
    "updateSupplyRequestStatus": IDL2.Func(
      [SupplyRequestId2, SupplyRequestStatus2],
      [IDL2.Opt(SupplyRequest2)],
      []
    ),
    "updateTrainingEnrollmentStatus": IDL2.Func(
      [EnrollmentId2, EnrollmentStatus2],
      [],
      []
    )
  });
...
class Backend {
  ...
  async createTrainingProgram(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.createTrainingProgram(to_candid_CreateTrainingInput_n17(this._uploadFile, this._downloadFile, arg0));
        return from_candid_TrainingProgram_n20(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async enrollInTraining(arg0) {
    if (this.processError) {
      try {
        ...
        return from_candid_TrainingEnrollment_n23(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async getMyAIQuizResult() {
    if (this.processError) {
      try {
        const result = await this.actor.getMyAIQuizResult();
  ...
  async getMyContactLeads() {
    if (this.processError) {
      try {
        const result = await this.actor.getMyContactLeads();
  ...
  async getMyPremiumRequest() {
    if (this.processError) {
      try {
        const result = await this.actor.getMyPremiumRequest();
  ...
  async getMyTrainingEnrollments() {
    if (this.processError) {
      try {
        const result = await this.actor.getMyTrainingEnrollments();
  ...
  async getProgramEnrollments(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.getProgramEnrollments(arg0);
        return from_candid_vec_n52(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async getTrainingProgram(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.getTrainingProgram(arg0);
  ...
  async listAllContactLeads() {
    if (this.processError) {
      try {
        const result = await this.actor.listAllContactLeads();
        return from_candid_vec_n42(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async listPremiumRequests() {
    if (this.processError) {
      try {
        const result = await this.actor.listPremiumRequests();
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async listTrainingPrograms() {
    if (this.processError) {
      try {
        const result = await this.actor.listTrainingPrograms();
  ...
  async markPremiumRequestContacted(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.markPremiumRequestContacted(arg0);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async saveCallerUserProfile(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.saveCallerUserProfile(to_candid_SaveProfileInput_n60(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async setExpertActive(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async submitAIQuiz(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.submitAIQuiz(arg0);
        return from_candid_AIQuizResult_n39(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async submitCase(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.submitCase(to_candid_CreateCaseInput_n62(this._uploadFile, this._downloadFile, arg0));
        return from_candid_Case_n32(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async submitContactLead(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.submitContactLead(arg0);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async submitPremiumRequest(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.submitPremiumRequest(arg0);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async submitSupplyRequest(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.submitSupplyRequest(arg0);
        return from_candid_SupplyRequest_n48(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async toggleTrainingProgramActive(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.toggleTrainingProgramActive(arg0);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateCase(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updateCase(arg0, to_candid_UpdateCaseInput_n64(this._uploadFile, this._downloadFile, arg1));
        return from_candid_opt_n31(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateSupplyRequestStatus(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updateSupplyRequestStatus(arg0, to_candid_SupplyRequestStatus_n68(this._uploadFile, this._downloadFile, arg1));
        return from_candid_opt_n54(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateTrainingEnrollmentStatus(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updateTrainingEnrollmentStatus(arg0, to_candid_EnrollmentStatus_n70(this._uploadFile, this._downloadFile, arg1));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
...
function from_candid_AIQuizResult_n39(_uploadFile, _downloadFile, value) {
  return from_candid_record_n40(_uploadFile, _downloadFile, value);
}
function from_candid_BusinessType_n22(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n8(_uploadFile, _downloadFile, value);
}
function from_candid_CaseStatus_n34(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n35(_uploadFile, _downloadFile, value);
}
function from_candid_Case_n32(_uploadFile, _downloadFile, value) {
  return from_candid_record_n33(_uploadFile, _downloadFile, value);
}
function from_candid_ContactLead_n43(_uploadFile, _downloadFile, value) {
  return from_candid_record_n44(_uploadFile, _downloadFile, value);
}
function from_candid_EnrollmentStatus_n25(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n26(_uploadFile, _downloadFile, value);
}
function from_candid_Expert_n5(_uploadFile, _downloadFile, value) {
  return from_candid_record_n6(_uploadFile, _downloadFile, value);
}
function from_candid_ResourceCategory_n15(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n16(_uploadFile, _downloadFile, value);
}
function from_candid_Resource_n13(_uploadFile, _downloadFile, value) {
  return from_candid_record_n14(_uploadFile, _downloadFile, value);
}
function from_candid_Specialization_n7(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n8(_uploadFile, _downloadFile, value);
}
function from_candid_SupplyRequestStatus_n50(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n51(_uploadFile, _downloadFile, value);
}
function from_candid_SupplyRequest_n48(_uploadFile, _downloadFile, value) {
  return from_candid_record_n49(_uploadFile, _downloadFile, value);
}
function from_candid_TrainingEnrollment_n23(_uploadFile, _downloadFile, value) {
  return from_candid_record_n24(_uploadFile, _downloadFile, value);
}
function from_candid_TrainingProgram_n20(_uploadFile, _downloadFile, value) {
...
function from_candid_opt_n31(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_Case_n32(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_opt_n38(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_AIQuizResult_n39(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_opt_n54(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_SupplyRequest_n48(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n55(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_TrainingProgram_n20(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n21(_uploadFile, _downloadFile, value) {
  return {
    ...
    description: value.description,
    sector: from_candid_BusinessType_n22(_uploadFile, _downloadFile, value.sector),
...
function from_candid_record_n24(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    status: from_candid_EnrollmentStatus_n25(_uploadFile, _downloadFile, value.status),
    userId: value.userId,
...
function from_candid_record_n29(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    aiRecommendation: record_opt_to_undefined(from_candid_opt_n30(_uploadFile, _downloadFile, value.aiRecommendation)),
    name: value.name,
    createdAt: value.createdAt,
    whatsapp: value.whatsapp,
    businessType: from_candid_BusinessType_n22(_uploadFile, _downloadFile, value.businessType),
    mobile: value.mobile,
...
function from_candid_record_n33(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    status: from_candid_CaseStatus_n34(_uploadFile, _downloadFile, value.status),
    userId: value.userId,
    createdAt: value.createdAt,
    businessType: from_candid_BusinessType_n22(_uploadFile, _downloadFile, value.businessType),
    description: value.description,
    ...
    updatedAt: value.updatedAt,
    assignedExpertId: record_opt_to_undefined(from_candid_opt_n36(_uploadFile, _downloadFile, value.assignedExpertId)),
    adminNotes: record_opt_to_undefined(from_candid_opt_n30(_uploadFile, _downloadFile, value.adminNotes))
  };
}
...
function from_candid_record_n44(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    status: value.status,
    userId: record_opt_to_undefined(from_candid_opt_n45(_uploadFile, _downloadFile, value.userId)),
    name: value.name,
    whatsapp: value.whatsapp,
...
function from_candid_record_n49(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    status: from_candid_SupplyRequestStatus_n50(_uploadFile, _downloadFile, value.status),
...
function from_candid_variant_n16(_uploadFile, _downloadFile, value) {
  return "poultry" in value ? "poultry" : "fish" in value ? "fish" : "goat" in value ? "goat" : "seeds" in value ? "seeds" : value;
}
function from_candid_variant_n26(_uploadFile, _downloadFile, value) {
  return "enrolled" in value ? "enrolled" : "completed" in value ? "completed" : "ongoing" in value ? "ongoing" : value;
}
function from_candid_variant_n35(_uploadFile, _downloadFile, value) {
  return "pending" in value ? "pending" : "completed" in value ? "completed" : "inProgress" in value ? "inProgress" : value;
}
function from_candid_variant_n51(_uploadFile, _downloadFile, value) {
  return "cancelled" in value ? "cancelled" : "pending" in value ? "pending" : "delivered" in value ? "delivered" : "processing" in value ? "processing" : value;
}
function from_candid_variant_n8(_uploadFile, _downloadFile, value) {
  return "fishery" in value ? "fishery" : "goatFarming" in value ? "goatFarming" : "poultry" in value ? "poultry" : "agriculture" in value ? "agriculture" : value;
}
function from_candid_vec_n41(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_Case_n32(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n42(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_ContactLead_n43(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n47(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_SupplyRequest_n48(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n52(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_TrainingEnrollment_n23(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n56(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_Expert_n5(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n57(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_Resource_n13(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n58(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_TrainingProgram_n20(_uploadFile, _downloadFile, x2));
}
...
function to_candid_BusinessType_n19(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n4(_uploadFile, _downloadFile, value);
}
function to_candid_CaseStatus_n66(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n67(_uploadFile, _downloadFile, value);
}
function to_candid_CreateCaseInput_n62(_uploadFile, _downloadFile, value) {
  return to_candid_record_n63(_uploadFile, _downloadFile, value);
}
function to_candid_CreateExpertInput_n1(_uploadFile, _downloadFile, value) {
  return to_candid_record_n2(_uploadFile, _downloadFile, value);
}
function to_candid_CreateResourceInput_n9(_uploadFile, _downloadFile, value) {
  return to_candid_record_n10(_uploadFile, _downloadFile, value);
}
function to_candid_CreateTrainingInput_n17(_uploadFile, _downloadFile, value) {
  return to_candid_record_n18(_uploadFile, _downloadFile, value);
}
function to_candid_EnrollmentStatus_n70(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n71(_uploadFile, _downloadFile, value);
}
function to_candid_ResourceCategory_n11(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n12(_uploadFile, _downloadFile, value);
}
function to_candid_SaveProfileInput_n60(_uploadFile, _downloadFile, value) {
  return to_candid_record_n61(_uploadFile, _downloadFile, value);
}
function to_candid_Specialization_n3(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n4(_uploadFile, _downloadFile, value);
}
function to_candid_SupplyRequestStatus_n68(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n69(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateCaseInput_n64(_uploadFile, _downloadFile, value) {
...
function to_candid_record_n18(_uploadFile, _downloadFile, value) {
  return {
    ...
    duration: value.duration,
    description: value.description,
    sector: to_candid_BusinessType_n19(_uploadFile, _downloadFile, value.sector)
  };
}
...
function to_candid_record_n61(_uploadFile, _downloadFile, value) {
  return {
    aiRecommendation: value.aiRecommendation ? candid_some(value.aiRecommendation) : candid_none(),
    name: value.name,
    whatsapp: value.whatsapp,
    businessType: to_candid_BusinessType_n19(_uploadFile, _downloadFile, value.businessType),
    mobile: value.mobile,
    location: value.location
  };
}
...
function to_candid_record_n65(_uploadFile, _downloadFile, value) {
  return {
    status: value.status ? candid_some(to_candid_CaseStatus_n66(_uploadFile, _downloadFile, value.status)) : candid_none(),
...
const mockPrincipal = { toString: () => "aaaa-bbbb-cccc-dddd" };
const mockBackend = {
  ...
  getMyCases: async () => [
    ...
    },
    {
      ...
      updatedAt: BigInt(Date.now() - 432e5),
  ...
  listAllCases: async () => [
    ...
    {
      id: BigInt(1002),
      userId: { toString: () => "xxxx-yyyy-zzzz" },
      businessType: "poultry",
    ...
    {
      id: BigInt(1003),
      userId: { toString: () => "pppp-qqqq-rrrr" },
      businessType: "fishery",
      description: "Fish pond water quality management.",
      status: "completed",
      createdAt: BigInt(Date.now() - 2592e5),
  ...
  saveCallerUserProfile: async () => void 0,
  ...
  getMyTrainingEnrollments: async () => [
    {
      ...
      programId: BigInt(1),
      status: "ongoing",
      enrolledAt: BigInt(Date.now() - 1728e5),
      updatedAt: BigInt(Date.now() - 864e5)
    },
    {
      id: BigInt(2),
      ...
      programId: BigInt(2),
      status: "enrolled",
      enrolledAt: BigInt(Date.now() - 864e5),
      updatedAt: BigInt(Date.now() - 864e5)
    },
    {
      id: BigInt(3),
      ...
      programId: BigInt(0),
      status: "completed",
      enrolledAt: BigInt(Date.now() - 6048e5),
  ...
  markPremiumRequestContacted: async () => void 0,
  submitAIQuiz: async () => ({
    businessType: "agriculture",
    confidence: "High",
  ...
  toggleTrainingProgramActive: async () => void 0,
  updateTrainingEnrollmentStatus: async () => void 0,
...
const _env = __vite_import_meta_env__;
function getRuntimeEnv() {
  const w2 = window;
  if (w2.__caffeine_env && typeof w2.__caffeine_env === "object") {
    return w2.__caffeine_env;
  }
  if (w2.__env && typeof w2.__env === "object") {
    return w2.__env;
  }
  return {};
}
function resolveCanisterId() {
  ...
  const buildTimeId = _env.CANISTER_ID_BACKEND || _env.VITE_CANISTER_ID_BACKEND || "";
  if (buildTimeId) {
    return buildTimeId;
  }
  return "";
}
const BUILD_TIME_ID = _env.CANISTER_ID_BACKEND || _env.VITE_CANISTER_ID_BACKEND || "";
const EXPLICIT_MOCK = _env.VITE_USE_MOCK === "true";
const USE_MOCK = EXPLICIT_MOCK && !BUILD_TIME_ID;
async function noopUpload(_file) {
  return new Uint8Array();
}
async function noopDownload(_bytes) {
...
function useBackend() {
  ...
  const backend = reactExports.useMemo(() => {
    ...
    if (!canisterId) {
      console.error(
        "[useBackend] Canister ID is required but could not be resolved. Checked: window.__caffeine_env.backend_canister_id, window.__env.backend_canister_id, CANISTER_ID_BACKEND (build-time), VITE_CANISTER_ID_BACKEND (build-time). The platform should populate /env.json at runtime with the real canister ID. Backend calls will fail until this is resolved."
      );
      return mockBackend;
    }
