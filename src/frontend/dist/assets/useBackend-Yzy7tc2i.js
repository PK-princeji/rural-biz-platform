...
class Backend {
  ...
  async saveCallerUserProfile(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.saveCallerUserProfile(to_candid_SaveProfileInput_n56(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async submitCase(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.submitCase(to_candid_CreateCaseInput_n58(this._uploadFile, this._downloadFile, arg0));
  ...
  async submitSupplyRequest(arg0) {
    if (this.processError) {
      try {
        ...
        return from_candid_SupplyRequest_n44(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async updateCase(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updateCase(arg0, to_candid_UpdateCaseInput_n60(this._uploadFile, this._downloadFile, arg1));
        return from_candid_opt_n31(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateSupplyRequestStatus(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updateSupplyRequestStatus(arg0, to_candid_SupplyRequestStatus_n64(this._uploadFile, this._downloadFile, arg1));
        return from_candid_opt_n50(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateTrainingEnrollmentStatus(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updateTrainingEnrollmentStatus(arg0, to_candid_EnrollmentStatus_n66(this._uploadFile, this._downloadFile, arg1));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
...
function from_candid_SupplyRequestStatus_n46(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n47(_uploadFile, _downloadFile, value);
}
function from_candid_SupplyRequest_n44(_uploadFile, _downloadFile, value) {
...
function from_candid_opt_n50(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_SupplyRequest_n44(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n45(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    status: from_candid_SupplyRequestStatus_n46(_uploadFile, _downloadFile, value.status),
...
function from_candid_vec_n43(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_SupplyRequest_n44(_uploadFile, _downloadFile, x2));
}
...
function to_candid_CaseStatus_n62(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n63(_uploadFile, _downloadFile, value);
}
function to_candid_CreateCaseInput_n58(_uploadFile, _downloadFile, value) {
...
function to_candid_EnrollmentStatus_n66(_uploadFile, _downloadFile, value) {
...
function to_candid_SaveProfileInput_n56(_uploadFile, _downloadFile, value) {
...
function to_candid_SupplyRequestStatus_n64(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n65(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateCaseInput_n60(_uploadFile, _downloadFile, value) {
...
function to_candid_record_n61(_uploadFile, _downloadFile, value) {
  return {
    status: value.status ? candid_some(to_candid_CaseStatus_n62(_uploadFile, _downloadFile, value.status)) : candid_none(),
